 ...
 * @returns {Uint8Array}
 */
function render_glb(pixels, img_w, img_h, channels, pattern, panel_w, panel_h, tile_size, lead_gap, glass_depth, frame_height, glass_alpha, palette, merge_cells) {
    const ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
function render_preview(pixels, img_w, img_h, channels, pattern, panel_w, panel_h, tile_size, lead_gap, glass_alpha, palette, out_w, out_h, merge_cells) {
    const ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(pattern, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
